...
3. **PlaceholderImageModule coverage**: When fixtures reference new image path patterns (e.g., `/smart/base/images/`, `/shopping/image/`), verify that `PlaceholderImageModule` has a matching route. Missing coverage → 404 → broken images.
